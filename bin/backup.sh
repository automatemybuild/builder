...
declare -a arraygithub=($HOME/github/*)
...
declare -a arraydavical=(/etc/apache2/sites-available/mydavicalsite.conf /etc/postgresql/10/main/pg_hba.conf /etc/init.d/postgresql /usr/share/davical/dba/create-database.sh /etc/apache2/ssl/key/vhost1.key /etc/apache2/ssl/crt/vhost1.crt /etc/davical/mydavicalsite.php $HOME/backup_davical.sh /etc/default/ufw /usr/share/davical/htdocs/* )
